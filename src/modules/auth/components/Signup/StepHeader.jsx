...
export default function StepHeader({step, prev, headerContent}) {
    ...
    const textClass = "font-poppins";

    return (
        <div className="relative w-full">
            <div className="h-15 flex flex-col justify-center">
                <p className={textClass + " text-[#B3B3B3]"}>Step {step ? step : null} of 3</p>
                <p className={textClass + " text-white font-semibold"}>{headerContent}</p>
            </div>
